...
namespace
{
	...
	{
		UNMOUNT_BEGINFRAME_HOOK
		UNMOUNT_FIXEDUPDATE_HOOK
		UNMOUNT_UPDATE_HOOK
		UNMOUNT_LATEUPDATE_HOOK
		UNMOUNT_ENDFRAME_HOOK
		UNMOUNT_POSTRENDERERINTIALIZE_HOOK
		UNMOUNT_POSTRENDERERRELEASE_HOOK
		UNMOUNT_POSTRENDERERPARSECOMMAND_HOOK
		UNMOUNT_POSTRENDERERSWAPBUFFER_HOOK
		UNMOUNT_POSTRENDERCONTEXTINITIALIZED_HOOK
		UNMOUNT_PRERENDERCONTEXTINRELEASED_HOOK
		UNMOUNT_SHOULDWAKEUPRENDERTHREAD_HOOK
		UNMOUNT_POSTCHRONOMETERTICK_HOOK
	}
