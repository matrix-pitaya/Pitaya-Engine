...
void Pitaya::Editor::GUI::SetStyle()
{
	...
	io.Fonts->AddFontFromMemoryTTF(const_cast<void*>(fontRC.data), fontRC.size, 16, &fontConfig, io.Fonts->GetGlyphRangesChineseFull());
	...
	io.Fonts->AddFontFromMemoryTTF(const_cast<void*>(iconsRC.data), iconsRC.size, 16.0f, &iconsConfig, iconsRanges);
