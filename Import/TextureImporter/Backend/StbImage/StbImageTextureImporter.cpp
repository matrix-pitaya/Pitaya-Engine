...
bool Pitaya::Import::StbImageTextureImporter::Import(Pitaya::Core::GUID guid, const std::filesystem::path& file, bool isFlipVerticallyOnLoad, SkyBoxImportResult& out)
{
    stbi_set_flip_vertically_on_load(isFlipVerticallyOnLoad);
...
bool Pitaya::Import::StbImageTextureImporter::Import(Pitaya::Core::GUID guid, const void* data, size_t size, bool isFlipVerticallyOnLoad, SkyBoxImportResult& out)
{
    stbi_set_flip_vertically_on_load(isFlipVerticallyOnLoad);
