...
namespace Pitaya::Import
{
	...
	public:
		...
		virtual bool Import(Pitaya::Core::GUID guid, const std::filesystem::path& file, bool isFlipVerticallyOnLoad, SkyBoxImportResult& out) = 0;
		virtual bool Import(Pitaya::Core::GUID guid, const void* data, size_t size, bool isFlipVerticallyOnLoad, SkyBoxImportResult& out) = 0;
	};
}
