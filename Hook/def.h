...
#define INVOKE_POSTRENDERCONTEXTINITIALIZED_HOOK(RTId) if(Pitaya::Engine::Global_PostRenderContextInitialized_Hook.Func) { Pitaya::Engine::Global_PostRenderContextInitialized_Hook.Func(RTId); }
