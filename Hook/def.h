...
#define INVOKE_POSTRENDERCONTEXTINITIALIZED_HOOK if(Pitaya::Engine::Global_PostRenderContextInitialized_Hook.Func) { Pitaya::Engine::Global_PostRenderContextInitialized_Hook.Func(); }
