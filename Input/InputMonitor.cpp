...
{
	keyToken = Pitaya::Event::Subscribe(
		Pitaya::Event::EventType::Key, 
		&Pitaya::Input::InputMonitor::OnKey, this);

	mouseButtonToken = Pitaya::Event::Subscribe(
		Pitaya::Event::EventType::MouseButton, 
		&Pitaya::Input::InputMonitor::OnMouseButton, this);
